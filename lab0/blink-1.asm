; See the NOTE on line 63 of this file.
;
$NOMOD51
;-----------------------------------------------------------------------------
...
; NOTE: This is the loop you need to observe, starting from the next line through
; the line "jmp Loop2".  Your objective is to calculate how many clock cycles
; your C8051F0120 takes to execute the loop exactly once.
